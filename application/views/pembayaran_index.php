<div class="box box-danger">
	...
	<div class="box-body" style="margin:10px;">
        ...
        <a href="<?php echo base_url() ?>pembayaran" class="btn btn-sm btn-default">Reset</a>
	    </div>
	   </form>
	  <?php if(count($pembayaran['entries'])) { ?>
			<table class="table table-bordered table-hover">
				...
				<tbody>
					<?php 
					$no = 1;
					foreach ($pembayaran['entries'] as $key => $pemesanan) {
					...
					?>
						<tr>
							...
							<td><a href="<?php echo base_url() ?>pembayaran/view/<?php echo $pemesanan['id_pemesanan'] ?>">Detail</td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
